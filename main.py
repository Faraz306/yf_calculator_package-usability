...
st.code("from yf-calculator import yf-calculator-ui")
st.write("Then, write:")
st.code("yf-calculator-ui(csv_path='your .csv path with button goes here.',"
        "text='your text in the About Us button', title='Your page title goes here.')")